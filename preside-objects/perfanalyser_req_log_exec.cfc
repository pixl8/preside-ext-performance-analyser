...
component {
	...
	property name="min_time"      type="numeric" dbtype="bigint" required=true                   indexes="mintime";
	property name="max_time"      type="numeric" dbtype="bigint" required=true                   indexes="maxtime";
	property name="mean_time"     type="numeric" dbtype="bigint" required=true                   indexes="meantime";
	property name="total_time"    type="numeric" dbtype="bigint" required=true                   indexes="totaltime";
	property name="load"          type="numeric" dbtype="bigint" required=true                   indexes="load";
}