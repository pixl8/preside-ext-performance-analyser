...
component {
	...
	property name="total_time" type="numeric" dbtype="bigint"  required=true              indexes="totaltime" renderer="perfAnalyserDuration";
	property name="query_time" type="numeric" dbtype="bigint"  required=true              indexes="querytime" renderer="perfAnalyserDuration";
